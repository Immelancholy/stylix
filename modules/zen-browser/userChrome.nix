...
''
  :root {
    ...
    --zen-themed-toolbar-bg-transparent: #${base01-hex}BB !important;
  }
  ...
  #historySwipeAnimationPreviousArrow,#historySwipeAnimationNextArrow {
    --swipe-nav-icon-primary-color: #${base0D-hex}BB !important;
    --swipe-nav-icon-accent-color: #${base00-hex}BB !important;
  }
